...
public class FireGemTaskV1 implements Runnable {

    private static final FireGemTaskV1 instance = new FireGemTaskV1();

    private FireGemTaskV1() {
    }
    ...
    public static FireGemTaskV1 getInstance() {
        return instance;
    }
}
